...
public class CameraController : MonoBehaviour
{
    ...
    public float InternalMoveTargetSpeed = 8;
    public float InternalMoveSpeed = 4;
    public float _internalZoomSpeed = 4;
    ...
    public void OnZoom(InputAction.CallbackContext context)
    {
        ...
        CurrentZoom = Mathf.Clamp(_currentZoomAmount - (context.ReadValue<Vector2>().y * zoomModifier), ZoomMax, ZoomMin);
    }
